...
export async function GET() {
  ...
  try {
    ...
    const openURL = tool({
      ...
      parameters: z.object({
        url: z.string().describe("The URL to open"), // ✅ no .url()
      }),
      async execute({ url }) {
...
- Use reliable CSS selectors from the form.
- Fill out the form with dummy data.
Steps:
1) open_url("https://ui.chaicode.com/auth/signup")
2) take_screenshot("signup_form_loaded")
3) type_text(selector='input[placeholder="First Name"]', text="John")
4) type_text(selector='input[placeholder="Last Name"]', text="Doe")
5) type_text(selector='input[type="email"]', text="john@example.com")
6) type_text(selector='input[type="password"] >> nth=0', text="Test@12345")
7) type_text(selector='input[type="password"] >> nth=1', text="Test@12345")
8) click(role="button", name="Create Account", selector="", nth=0)
9) take_screenshot("submitted")
...
1) open_url("https://ui.chaicode.com/auth/signup")
2) take_screenshot("signup_form_loaded")
3) type_text(selector='input[placeholder="First Name"]', text="${firstName}")
4) type_text(selector='input[placeholder="Last Name"]', text="${lastName}")
5) type_text(selector='input[type="email"]', text="${email}")
6) type_text(selector='input[type="password"] >> nth=0', text="${password}")
7) type_text(selector='input[type="password"] >> nth=1', text="${confirmPassword}")
8) take_screenshot("form_filled")
9) click(role="button", name="Create Account", selector="", nth=0)
